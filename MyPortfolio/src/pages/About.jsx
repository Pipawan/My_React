  ...
  return (
    <div className="about-container">
      <div className="text-container">
        <h1>About Me</h1>
        <p>Hi! I am Pawan, a Software Engineer who loves building websites. I create 
        ...
        <p>
          ...
          I have learned many programming languages and tools over the years. I like working 
